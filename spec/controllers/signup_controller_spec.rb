...
RSpec.describe SignupController, type: :controller do
  ...
  describe "patient account creation" do
    ...
    it "receives incomplete fields" do
      post :add, {:session => {:username => nil, :first_name => "New", :last_name_string => "User", :address => "11 Eleven St", :pnumber => "D12", :Healthcare => "waypoint", :password => "pass", :confirmPassword => "pass2"} }
      expect(response).to redirect_to(signup_signup_path)
    end
    it "is successful" do
